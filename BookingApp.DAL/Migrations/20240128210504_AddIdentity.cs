    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentBooking", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartmentBooking_Apartment_Ap_Id",
                        column: x => x.Ap_Id,
                        principalTable: "Apartment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApartmentBooking_AspNetUsers_User_Id",
                        column: x => x.User_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentReview", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApartmentReview_Apartment_Apartment_Id",
                        column: x => x.Apartment_Id,
                        principalTable: "Apartment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApartmentReview_AspNetUsers_User_Id",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HotelReview_AspNetUsers_User_Id",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelReview_Hotel_Hotel_Id",
                        column: x => x.Hotel_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastDay = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NumberOfPeople = table.Column<int>(type: "int", nullable: false),
                    HotelDTOId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomBooking", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomBooking_AspNetUsers_User_Id",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomBooking_Hotel_HotelDTOId",
                        column: x => x.HotelDTOId,
                        principalTable: "Hotel",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentBooking_Ap_Id",
                table: "ApartmentBooking",
                column: "Ap_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentBooking_User_Id",
                table: "ApartmentBooking",
                column: "User_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentReview_Apartment_Id",
                table: "ApartmentReview",
                column: "Apartment_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentReview_User_Id",
                table: "ApartmentReview",
                column: "User_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelReview_Hotel_Id",
                table: "HotelReview",
                column: "Hotel_Id");

            migrationBuilder.CreateIndex(
                name: "IX_HotelReview_User_Id",
                table: "HotelReview",
                column: "User_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomBooking_HotelDTOId",
                table: "RoomBooking",
                column: "HotelDTOId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomBooking_Room_Id",
                table: "RoomBooking",
                column: "Room_Id");

            migrationBuilder.CreateIndex(
                name: "IX_RoomBooking_User_Id",
                table: "RoomBooking",
                column: "User_Id");

            migrationBuilder.AddForeignKey(
                name: "FK_FavoriteApartment_Apartment_ApartmentId",
                table: "FavoriteApartment",
                column: "ApartmentId",
                principalTable: "Apartment",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FavoriteApartment_AspNetUsers_UserId",
                table: "FavoriteApartment",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FavoriteHotel_AspNetUsers_UserId",
                table: "FavoriteHotel",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
